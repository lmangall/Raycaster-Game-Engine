...
int	main(void)
{
	...
	// ft_lstadd_back(&animator3000.animations, ft_lstnew(ball_animation(5,
	// 32)));
	// ft_lstadd_back(&animator3000.animations, ft_lstnew(rect_animation(5,
	// 32)));
	ft_lstadd_back(&animator3000.animations, ft_lstnew(rect_animation_pulga(5,
				32)));
	ft_lstadd_back(&animator3000.animations, ft_lstnew(ball_animation_pulga(5,
				32)));
	...
	destroy_animation(animator3000.animations);
	destroy_animator(&animator3000);
	exit(0);
}