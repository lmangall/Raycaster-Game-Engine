...
SRCS	= main.c init.c old_parser.c render.c exit.c movement.c raycasting.c load_textures.c parser/parser.c parser/parse_file.c parser/parse_file_utils.c parser/check_file.c parser/process_map.c parser/process_map_elements.c parser/process_map_content.c parser/parser_utils.c parser/init.c parser/process_map_content_height_width.c parser/process_map_content_checks.c parser/process_map_content_check_spaces.c parser/debugger.c
