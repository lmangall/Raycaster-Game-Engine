 ...
 *
 * @param r Red component, usually in the range [0, 255]
 * @param g Green component, usually in the range [0, 255]
 * @param b Blue component, usually in the range [0, 255]
 * @param a Alpha component for transparency, usually in the range [0, 255]
 */
 ...
 * - player_found: Flag if the player has been found.
 * - width: Map width in tiles.
 * - height: Map height in tiles.
 * - c: Ceiling color, using the t_rgba struct for RGBA color format.
 * - f: Floor color, using the t_rgba struct for RGBA color format.
 * - textures_paths: Pointer to a structure holding paths to texture files.
 */
